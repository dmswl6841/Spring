...
<body>
	<aside id="layout-menu"
		...
		<div class="app-brand demo">
			<a href="userHome.do" class="app-brand-link"> <span
			...
			</span> <span class="app-brand-text demo menu-text fw-bolder ms-2">WEB</span>
		...
		<ul class="menu-inner py-1">
			<!-- Dashboard -->
			<li class="menu-item active"><a href="memberLogin.do" class="menu-link">
					<i class="menu-icon tf-icons bx bx-home-circle"></i>
					<div data-i18n="Analytics">LogIN</div>
			</a></li>
			<li class="menu-item active"><a href="main.do" class="menu-link">
					<i class="menu-icon tf-icons bx bx-home-circle"></i>
					<div data-i18n="Analytics">My page</div>
			</a></li>
			...
			<li class="menu-item"><a href="javascript:void(0);"
				...
				<ul class="menu-sub">
					...
					<li class="menu-item"><a
						href="pages-account-settings-notifications.html" class="menu-link">
			...
			<li class="menu-item"><a href="javascript:void(0)"
				...
				<ul class="menu-sub">
					...
					<li class="menu-item"><a href="ui-pagination-breadcrumbs.html"
						class="menu-link">
			...
			<li class="menu-item"><a href="javascript:void(0)"
				...
				<ul class="menu-sub">
					...
					<li class="menu-item"><a href="extended-ui-text-divider.html"
						class="menu-link">
