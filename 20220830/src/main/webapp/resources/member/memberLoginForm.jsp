...
<title>Login Basic - Pages | Sneat - Bootstrap 5 HTML Admin
	Template - Pro</title>
...
<!-- Page -->
<link rel="stylesheet"
	href="resources/assets/vendor/css/pages/page-auth.css" />
<!-- Helpers -->
                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                          <g id="Icon" transform="translate(27.000000, 15.000000)">
							...
							</span> <span class="app-brand-text demo text-body fw-bolder">Sneat</span>
							</a>
						</div>
						<!-- /Logo -->
						...
						<form id="formAuthentication" class="mb-3" action="memberLogin.do"
							method="POST">
							<div class="mb-3">
								<label for="your id" class="form-label">ID</label>
								<input type="text" class="form-control" id="memberId" name="memberId" placeholder="Enter your ID" autofocus />
							</div>
